...
> Use this template to create new Agent Skills for Cursor.
...
description: Brief description of what this skill does. Include WHEN the agent should use it.
---
...
Output: What the agent should do/produce
...
Cursor only loads additional files when needed (progressive disclosure).

---

## Tool-Restricted Template

Limit what tools the agent can use with this skill:
